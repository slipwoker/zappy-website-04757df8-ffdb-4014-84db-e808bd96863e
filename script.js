    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Cosmetic-Shop משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5001/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '04757df8-ffdb-4014-84db-e808bd96863e',
                    name: data.name || '',
                    email: data.email || '',
